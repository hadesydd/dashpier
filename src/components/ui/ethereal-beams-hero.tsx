...
import { type FC, type ReactNode, forwardRef, useEffect, useImperativeHandle, useMemo, useRef } from "react";
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-3">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-white/60">Writing Styles</div>
              </div>
            </div>
          </div>
        </div>
